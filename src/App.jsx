...
function App() {
  ...
  useEffect(() => {
    if (
      usuario &&
      [...ROLES_CON_CHECADOR, "encargado_general"].includes(usuario.rol)
    ) {
  ...
  if (ROLES_CON_CHECADOR.includes(usuario.rol) && yaCheco === false) {
    return (
      <div
        style={{ maxWidth: "600px", margin: "0 auto", fontFamily: "system-ui" }}
      >
        <div
          style={{
            background: "#2E7D32",
  ...
  const mostrarBannerBeyin =
    usuario.rol === "encargado_general" && yaCheco === false;
  const esAccion = [
    "muerte",
    "traspaso",
    "etapa",
    ...
    <>
      ...
      {pagina === "vacunas" && (
        <Vacunas
          usuario={usuario}
          onVolver={
            ["parideras", "crecimiento", "gestacion"].includes(usuario.rol)
              ? () => irA("mapa")
              : null
          }
        />
      ...
      {pagina === "verificar_preñez" && corralSeleccionado && (
        <VerificarPreñez
          corral={corralSeleccionado}
          usuario={usuario}
          onVolver={handleVolver}
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ fontWeight: "800", fontSize: "20px", color: "white" }}
            >
              🐖 Corralia
            </div>
            <div
            ...
            {menuItems.map(([pag, label]) => (
              <button
                ...
                style={{
                  ...
                  padding: "10px 14px",
                  background:
                    pagina === pag ? "rgba(255,255,255,0.2)" : "transparent",
                  border: "none",
                  borderRadius: "8px",
                  cursor: "pointer",
                  textAlign: "left",
  ...
  return (
    ...
    >
      ...
      {mostrarBannerBeyin && (
        ...
        >
          <span
            style={{ color: "#F57F17", fontWeight: "600", fontSize: "14px" }}
          >
