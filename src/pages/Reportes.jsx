...
function Reportes() {
  ...
  const [icaFin, setIcaFin] = useState(
  ...
  const cargarIca = async () => {
    const r = await api.get(
      `/reportes/ica?fecha_inicio=${icaInicio}&fecha_fin=${icaFin}`,
    );
    setIca(r.data);
  };
  ...
  return (
    <div style={{ padding: "16px" }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            >
              ...
              <span>
                {reporte.inventario.reduce((s, r) => s + r.total, 0)} animales
              </span>
            </div>
          </div>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            >
              {[
                ...
                [
                  "🔄 Traspasos",
                  reporte.movimientos["TRASPASO"] || 0,
                  "#6A1B9A",
                ],
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div
              style={{
                background:
                  reporte.finanzas.utilidad >= 0 ? "#f1f8e9" : "#ffebee",
            ...
            >
              ...
              <div
                style={{
                  fontSize: "28px",
                  fontWeight: "800",
                  color: reporte.finanzas.utilidad >= 0 ? "#2E7D32" : "#C62828",
                }}
              >
                $
                {reporte.finanzas.utilidad.toLocaleString("es-MX", {
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              >
                {[
                  [
                    "Ventas",
                    reporte.finanzas.ventas,
                    reporte.anterior.ventas,
                    true,
                  ],
                  [
                    "Gasto alimento",
                    reporte.finanzas.almacen,
                    reporte.anterior.almacen,
                    false,
                  ],
                  [
                    "Muertes",
                    reporte.movimientos["MUERTE"] || 0,
                    reporte.anterior.muertes,
                    false,
                  ],
      ...
      <div style={{ marginBottom: "20px" }}>
        <h4 style={{ margin: "0 0 4px", color: "#444" }}>
          🌽 ICA zona Crecimiento
        </h4>
        <p style={{ fontSize: "12px", color: "#888", margin: "0 0 8px" }}>
          Índice de Conversión Alimenticia. Estándar: 2.5 o menos. Define el
          período de una camada.
        </p>
        <div style={{ display: "flex", gap: "8px", marginBottom: "12px" }}>
          <div style={{ flex: 1 }}>
            ...
            <input
              type="date"
              value={icaInicio}
              onChange={(e) => setIcaInicio(e.target.value)}
              style={{
                width: "100%",
                padding: "8px",
                borderRadius: "8px",
          ...
          <div style={{ flex: 1 }}>
            ...
            <input
              type="date"
              value={icaFin}
              onChange={(e) => setIcaFin(e.target.value)}
              style={{
                width: "100%",
                padding: "8px",
                borderRadius: "8px",
            ...
            >
              <div>
                ...
                <div style={{ fontSize: "12px", color: "#888" }}>
                  {r.kg_alimento.toFixed(1)} kg alimento ·{" "}
                  {r.kg_vendidos.toFixed(1)} kg vendidos · {r.num_ventas} ventas
                </div>
              </div>
