...
function Movimientos() {
  ...
  const filtrados =
    filtro === "TODOS"
      ? movimientos
      : movimientos.filter((m) => m.tipo_evento === filtro);
  ...
  return (
    <div style={{ padding: "16px" }}>
      <h2 style={{ margin: "0 0 16px" }}>📜 Movimientos</h2>
      ...
      {filtrados.map((m, i) => {
        const cfg = COLORES_EVENTO[m.tipo_evento] || {
          bg: "#f5f5f5",
          color: "#555",
          emoji: "📋",
        };
