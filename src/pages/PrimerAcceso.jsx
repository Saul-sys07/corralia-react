...
function PrimerAcceso({ usuario, tokenTemporal, onActivar }) {
  ...
  const activar = async () => {
    ...
    setError("");
    try {
      const respActivar = await fetch(
        "https://web-production-7c992.up.railway.app/usuarios/activar",
        {
          method: "POST",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          type="password"
          placeholder="Crea tu PIN (mín. 4 dígitos)"
          value={pin}
          onChange={(e) =>
        ...
        <input
          ...
          value={confirma}
          onChange={(e) =>
            setConfirma(e.target.value.replace(/\D/g, "").slice(0, 6))
          }
          style={inputStyle}
        />
