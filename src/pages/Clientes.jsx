...
function ListaClientes({ clientes }) {
  if (clientes.length === 0)
    return <p style={{ color: "#888" }}>Sin clientes registrados.</p>;
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              <span
                style={{
                  background: TIPO_COLORES[c.tipo],
                  color: "white",
                  padding: "4px 10px",
                  borderRadius: "20px",
                  fontSize: "12px",
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ fontWeight: "700", color: "#1976D2" }}>
                $
                {parseFloat(c.total_comprado).toLocaleString("es-MX", {
    ...
    <div>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          {vendedores.map((v) => (
            <button
              key={v.id}
              onClick={() => setVendedorId(Number(v.id))}
              style={{
                padding: "10px 14px",
                borderRadius: "8px",
                cursor: "pointer",
      ...
      <button
        ...
        style={{
          ...
          padding: "14px",
          background:
            loading || !nombre || !telefono || !vendedorId ? "#ccc" : "#2E7D32",
          color: "white",
          border: "none",
          borderRadius: "10px",
          fontSize: "16px",
