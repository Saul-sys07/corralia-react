...
function Ventas() {
  ...
  const totalMes = historial.reduce(
    (s, v) => s + parseFloat(v.total_rancho),
    0,
  );
  const totalComisiones = historial.reduce(
    (s, v) => s + parseFloat(v.total_comision),
    0,
  );
    ...
    <div style={{ padding: "16px" }}>
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontSize: "20px", fontWeight: "800", color: "#2E7D32" }}
          >
        ...
        >
          ...
          <div
            style={{ fontSize: "20px", fontWeight: "800", color: "#F57F17" }}
          >
            $
            {totalComisiones.toLocaleString("es-MX", {
              ...
              >
                ...
                >
                  ...
                  <strong style={{ color: "#2E7D32" }}>
                    $
                    {parseFloat(v.total_rancho).toLocaleString("es-MX", {
                ...
                >
                  Registrado por: {v.registrado_por} · Comisión para:{" "}
                  {v.vendedor_cliente}
                  {" · "}
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {c.num_ventas} ventas ·{" "}
                      {parseFloat(c.kg_vendidos).toFixed(0)}kg vendidos
                    </div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    ...
                    >
                      $
                      {parseFloat(c.total_comision).toLocaleString("es-MX", {
                        minimumFractionDigits: 2,
                      })}
                    </div>
